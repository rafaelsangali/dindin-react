...
export default function FirstPostComponents(){
return (
    <>
    <div className="area-postagem">
            <section>
                <h1>On the other hand, we denounce</h1>
                <p className="data">27 de dezembro de 2020</p>
                <img src={img} alt="Foto ilustrativa da postagem" />
            ...
            <section>
                <h2>These cases are perfectly simple and easy to distinguis</h2>
